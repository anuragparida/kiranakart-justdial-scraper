...
def getlatlong(storeAddress):
    ...
    # geocoder = GoogleGeocoder("AIzaSyB7qaZ2vcRKN3x7CxaU4r8G6CW9HndS_24")
...
def main():
    with open("outputCSVs/combinedCSV1.csv", "r") as csvfile:
        ...
        for row in sheetData[:1]:
            # time.sleep(0.5)
            searchStr1 = "http://dev.virtualearth.net/REST/v1/Locations?key=Ani4c0T0iZThBpgHlN_XxfrfQGWxB49QgD-HE0UWihotnekLW5S_v5G1y6IG0Pv0&q=" + \
